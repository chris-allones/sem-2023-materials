...
subtitle: "Session 2: Exploratory Factor Analysis (EFA)"
...
format: 
  revealjs:
    ...
    chalkboard: true
    slide-number: true
    footer: "Exploratory factor analysis"
engine: knitr
from: markdown+emoji
...
## working directory
setwd("~/GitHub-repo/sem-2023-materials/sem_presentations/02-efa")
...
![](image/Intro to SEM.png){fig-align="center" height=40% width=40%}
